...
Here's an example for the training cluster in the `proserve` project (you need to choose a different value for -r and -n):
```
./setup_f5_gke.sh -c <CLUSTER> -p <GCLOUD_PROJECT> -z <ZONE> -n <NAMESPACE> -r <RELEASE> --version 5.0.2
```
