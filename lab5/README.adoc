...
Rename `resources.yaml` to `gke_lw-sales-trng_wtsenglabs_fusion_resources.yaml`
...
Append `gke_lw-sales-trng_wtsenglabs_fusion_resources.yaml` to the `MY_VALUES` var in the upgrade script. Run the upgrade script to apply your changes.
