...
Rename `resources.yaml` to `gke_<CLUSTER>_${LW_K8S_RELEASE}_fusion_resources.yaml`
...
Append `gke_<CLUSTER>_${LW_K8S_RELEASE}_fusion_resources.yaml` to the `MY_VALUES` var in the upgrade script. Run the upgrade script to apply your changes.
